...
const questions = [
    ...
    { level: 1, question: "¿Cuánto tiempo tardó aproximadamente en llegar la noticia de la Independencia a Costa Rica?", options: ["2 días", "1 semana", "Un cañazo, Casi un mes", "3 meses"], answer: 2, fact: "La distancia y las condiciones de transporte hicieron que la noticia viajara lentamente en el 'Correo de Mulas'." },
    { level: 1, question: "¿Cuál fue la capital de Costa Rica cuando llegó la noticia en 1821?", options: ["San José", "Heredia", "Alajuela, (En la Catedral del Fotbol)", "Cartago"], answer: 3, fact: "Cartago ostentaba el título de capital colonial de Costa Rica en aquel momento histórico." },
    ...
    { level: 2, question: "¿Quién compuso la música del Himno Nacional de Costa Rica?", options: ["José María Zeledón", "Manuel María Gutiérrez", "Juan Rafael Mora", "Tolebrio (Again)"], answer: 1, fact: "Manuel María Gutiérrez compuso la música en 1852 bajo la presidencia de Juan Rafael Mora Porras." },
    ...
    { level: 2, question: "¿Quién diseñó la bandera tricolor de Costa Rica?", options: ["Francisca Carrasco", "Pacífica Fernández", "Ángela Acuña", "Bernarda Vásquez"], answer: 1, fact: "Se inspiró en los ideales de libertad y los colores de la bandera de Francia en 1848." },
    ...
    { level: 2, question: "¿Qué significan los 3 volcanes en el escudo?", options: ["Los 3 poderes", "Tres cordilleras", "Las 3 Copas Centroamericanas de la Liga", "Héroes de 1856"], answer: 1, fact: "Representan las tres cordilleras volcánicas que cruzan el territorio nacional." },
